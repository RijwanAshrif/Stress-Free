    ...
    <div class="main-content">
        ...
        <div class="main-content-inner">
            ...
            <ul class="ajax-sidebar">
                ...
                <li><a href="#<?php echo PUSH_GENERAL; ?>">General</a></li>
            </ul>
            ...
            <div class="ajax-form-wrapper loader-wrapper">
                ...
                <form class="ajax-form tab-form push_notification" id="<?php echo PUSH_GENERAL; ?>" method="post"
                      data-url="<?php echo PUSH_GENERAL_API; ?>">
                    ...
                    <div class="item-content">
                        ...
                        <label>Message</label>
                        <input type="text" data-ajax-field="true" placeholder="Message" name="message" value=""/>
...
<script>
    ...
    (function ($) {
        ...
        ajaxSidebarInit(window.location.hash, '<?php echo PUSH_GENERAL; ?>');

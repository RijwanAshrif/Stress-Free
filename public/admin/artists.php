    ...
    <div class="main-container">
        ...
        <div class="main-content">
            ...
            <div class="oflow-hidden mb-xs-0">
                ...
                <h6 class="float-r mt-5"><b><a class="c-btn" href="artist-form.php">+ Add Artist</a></b></h6>
            </div>
            ...
            <div class="item-wrapper loader-wrapper p-10">
                ...
                <table data-edit-link="artist-form.php?id=" data-delete-link="<?php echo ARTIST_DELETE_API . '?id='; ?>">
                    <thead>
...
<script>
    ...
    (function ($) {
        ...
        var getAllAPI = '<?php echo ARTIST_ALL_API; ?>',
            sort = '<?php echo $sort; ?>',
            sortType = "DESC";
